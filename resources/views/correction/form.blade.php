...
<div class="col-sm-12">
  <hr />
  <label>Submitted in the system during</label>
  <textarea name="details" id="submitted_during" class="form-control"></textarea>
</div>
...
<div class="col-sm-12">
  <div class="pull-right" style="margin-top: 20px;">
    <div class="btn-group">
        <button type="submit" id="correction-btn" class="btn btn-md btn-primary btn-block">
        <span>Submit</span>
      </button>
    </div>
    <div class="btn-group">
      <a type="button" id="cancel" class="btn btn-md btn-default" href="{{ url('correction') }}">Cancel</a>
    </div>
  </div>
</div>
