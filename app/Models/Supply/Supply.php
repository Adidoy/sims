...
class Supply extends Model
{
	...
	/**
	 * Filters the search result by array of
	 * stock number
	 *
	 * @param Builder $query
	 * @param array $array
	 * @return object
	 */
	public function scopeStockNumbers($query, array $array)
	{
		return $query->whereIn('stocknumber', $array);
	}
	...
	/**
	 * Returns relationship with category class
	 *
	 * @return void
	 */
